#!/usr/bin/env python3
"""Service GOOSE : tourne en permanence et envoie les flux GOOSE configurés via API HTTP."""
...
from goose61850.service import GooseService
...
def main() -> None:
    ...
    parser.add_argument(
        "--host",
        default="127.0.0.1",
        help="Adresse d'écoute de l'API HTTP (défaut: 127.0.0.1).",
    )
    parser.add_argument(
        "--port",
        type=int,
